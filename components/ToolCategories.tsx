...
const categories = [
  {
    ...
    tools: "4 live tools",
    description:
      "Practical tools for GIS, surveying, water and engineering fieldwork, including coordinates, measurements, bearings and water storage sizing.",
  },
  {
    icon: FileText,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-base leading-7 text-gray-600 sm:text-lg">
            Start with practical field, GIS and engineering tools now, then use YAJU for document and image workflows from the same workspace.
          </p>
        </motion.div>
          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-6 text-2xl font-bold text-gray-900">{category.title}</h3>
                <p className="mt-2 font-semibold text-blue-600">{category.tools}</p>
                <p className="mt-4 flex-1 leading-7 text-gray-600">{category.description}</p>
                <Link
                  href={category.href}
